...
static bool testLineComment([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testBracketComment([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testMultiComment([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testSpaceFirstNoArguments([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testSpaceAfterNoArguments([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testBracketArgument([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testQuotedArgument([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testUnquotedArgument([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testUnquotedLegacyArgument([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testUnquotedLegacyArgument2([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testSpaceBeforeArgument([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testSpaceAfterArgument([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testMultiArgument([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testMultilineCommand([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testArgumentsInArguments([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
static bool testEscapeCharacters([[maybe_unused]] Tester& tester)
{
	using namespace CMakeLexer;
...
[[maybe_unused]] LexerTestsRegister lexerTestsRegister;